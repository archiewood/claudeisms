...
*For list see [`claudeisms.csv`](https://github.com/archiewood/claudeisms/blob/main/claudeisms.csv)*
...
Full ranking, 144 words at 20x or above, is in [`claudeisms.csv`](https://github.com/archiewood/claudeisms/blob/main/claudeisms.csv). These are the top 12
